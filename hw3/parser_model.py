...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        x = torch.index_select(self.embeddings,0,w.flatten()).view(w.shape[0],w.shape[1]*self.embed_size)
    ...
    def forward(self, w):
        ...
        h_beforerelu = torch.mm(x,self.embed_to_hidden_weight) + self.embed_to_hidden_bias
        h_afterrelu = F.relu(h_beforerelu)
        hidden = self.dropout(h_afterrelu)
